const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./HomePage-SYAaWRMT.js","./mui-vendor-CTE_O7gT.js","./styled-components-eg0Rzwc1.js","./react-vendor-BS-dYsv0.js","./icons-CcncyDR1.js","./animation-DwHr2ej_.js","./routing-oDjbPx8E.js","./ProxyPage-Bye7aYXm.js","./PageContentLayout-2hb2Ff8p.js","./StatusIndicator-7Lw0xWRZ.js","./utils-CO-nVJB8.js","./ModernChatPage-CWzCaKz9.js","./DevEnvironmentPage-BUu1fveJ.js","./SettingsPage-C1dAb78w.js","./LLMConfigPage-Bqdyo4zP.js","./InfoPage-CcArLvtD.js"])))=>i.map(i=>d[i]);
import { c as createTheme, j as jsxRuntimeExports, T as ThemeProvider } from "./mui-vendor-CTE_O7gT.js";
import { r as reactExports, a as React, o as ot, d as dt, m as mt, f as ft } from "./styled-components-eg0Rzwc1.js";
import { r as requireReact, a as requireReactDom, g as getDefaultExportFromCjs } from "./react-vendor-BS-dYsv0.js";
import { m as motion, A as AnimatePresence } from "./animation-DwHr2ej_.js";
import { u as useLocation, L as Link, a as useNavigate, B as BrowserRouter, R as Routes, b as Route } from "./routing-oDjbPx8E.js";
import { H as House, S as Shield, B as Bot, a as Settings, C as Code, I as Info, b as ChevronLeft, c as ChevronRight, d as Search, e as Sun, M as Moon, U as User, f as Minimize, g as Maximize, X, T as TriangleAlert, h as CircleAlert, i as CircleCheckBig } from "./icons-CcncyDR1.js";
var client = { exports: {} };
...
const muiLightGlassTheme = createTheme({
  palette: {
    mode: "light",
    // 使用light模式
...
const muiDarkGlassTheme = createTheme({
  palette: {
    mode: "dark",
...
const CustomThemeProvider = ({ children }) => {
  const [theme, setTheme] = reactExports.useState(lightGlassTheme);
  ...
  const [themeMode, setThemeModeState] = reactExports.useState("lightGlass");
  ...
  const getThemeForMode = (mode, systemDark) => {
    switch (mode) {
      case "darkGlass":
        return { theme: darkGlassTheme, isDark: true, name: "darkGlass" };
      case "lightGlass":
        return { theme: lightGlassTheme, isDark: false, name: "lightGlass" };
      case "auto":
        return systemDark ? { theme: darkGlassTheme, isDark: true, name: "darkGlass" } : { theme: lightGlassTheme, isDark: false, name: "lightGlass" };
      default:
        return { theme: lightGlassTheme, isDark: false, name: "lightGlass" };
    }
  };
  const updateTheme = (mode, systemDark) => {
    const { theme: theme2, isDark, name } = getThemeForMode(mode, systemDark);
    setIsDarkMode(isDark);
    setTheme({ ...theme2, name });
  };
  const toggleTheme = () => {
  ...
  reactExports.useEffect(() => {
    const initializeTheme = async () => {
      try {
        ...
        const savedThemeMode = result?.success ? result.data : localStorage.getItem("themeMode") || "lightGlass";
        ...
        const savedThemeMode = localStorage.getItem("themeMode") || "lightGlass";
        const initialSystemPrefersDark = checkSystemTheme();
        setSystemPrefersDark(initialSystemPrefersDark);
        systemPrefersDarkRef.current = initialSystemPrefersDark;
        setThemeModeState(savedThemeMode);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeContext.Provider, { value: {
    ...
    toggleSidebar,
    muiTheme
  }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme: muiTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ot, { theme: { ...theme, name: isDarkMode ? "darkGlass" : "lightGlass" }, children }) }) });
};
...
const navigationItems = [
  {
    items: [
      ...
      { path: "/llm-config", label: "LLM 配置", icon: Settings },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      SidebarContainer,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(NavSection, { $collapsed: isSidebarCollapsed, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              LogoButton,
              {
                $collapsed: isSidebarCollapsed,
          ...
          isSidebarCollapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "0 10px", marginTop: "auto" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(CollapseButton, { onClick: toggleSidebar, style: { position: "static", width: "100%", borderRadius: "8px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 16 }) }) })
        ]
      }
    ),
    tooltip && /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { style: { top: tooltip.y, left: tooltip.x }, children: tooltip.text })
  ] });
};
...
const UserProvider = ({ children }) => {
  const [nickname, setNickname] = reactExports.useState("Guest");
...
const TitleBarContainer = dt(motion.div)`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
  ...
  `;
const LeftSection = dt.div`
  display: flex;
  align-items: center;
  gap: 16px;
  -webkit-app-region: drag;
`;
const AppLogo = dt(motion.div)`
  display: flex;
  align-items: center;
  gap: 8px;
  font-weight: 600;
...
const LogoIcon = dt.div`
  ...
  `;
const SearchContainer = dt(motion.div)`
  position: relative;
...
`;
const UserProfileContainer = dt(motion.div)`
  display: flex;
  align-items: center;
  gap: 8px;
  padding: 4px;
...
`;
const UserName = dt.span`
  font-size: 14px;
  font-weight: 500;
  color: ${(props) => props.theme.titleBar.text};
  padding-right: 8px;
`;
const WindowControls = dt.div`
  display: flex;
  gap: 4px;
  -webkit-app-region: no-drag;
`;
const WindowButton = dt(motion.button)`
  width: 32px;
  height: 32px;
...
const TitleBar = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    TitleBarContainer,
    {
      ...
      theme,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(LeftSection, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            AppLogo,
            {
              ...
              whileTap: { scale: 0.95 },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(LogoIcon, { theme, children: "C" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Catalyst" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(RightSection, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ThemeToggleButton,
            {
              ...
              title: "切换主题",
              theme,
              children: theme.name === "dark" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { size: 18 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { size: 18 })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ActionButton,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            UserProfileContainer,
            {
              ...
              title: "用户设置",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(UserAvatar, { children: avatar ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: avatar, alt: "User Avatar" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 16 }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(UserName, { children: nickname })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(WindowControls, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              WindowButton,
              {
                variant: "minimize",
                ...
                title: "最小化",
                theme,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Minimize, { size: 16 })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              WindowButton,
              {
                ...
                title: "最大化",
                theme,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Maximize, { size: 16 })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              WindowButton,
...
const LayoutContainer = dt(motion.div)`
  display: flex;
  flex-direction: column;
  height: 100vh;
...
class ConfigManager {
    ...
    try {
      ...
      if (activeConfig) {
        ...
        if (apiKeyResult.success && apiKeyResult.data) {
          configs = configs.map(
            (config) => config.isActive ? { ...config, apiKey: apiKeyResult.data } : config
          );
        }
      }
  ...
  isConfigValid() {
    ...
    return !!(activeConfig.provider && activeConfig.model && activeConfig.apiKey && activeConfig.baseUrl);
  }
  // 添加配置
  async addConfig(config) {
    ...
    const newConfig = {
      ...config,
      id: this.generateId(),
      isActive: this.configs.length === 0
      // 第一个配置默认激活
    };
...
const ConfigProvider = ({ children }) => {
  ...
  const [isConfigValid, setIsConfigValid] = reactExports.useState(false);
...
const HomePage = reactExports.lazy(() => __vitePreload(() => import("./HomePage-SYAaWRMT.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0, import.meta.url));
const ProxyPage = reactExports.lazy(() => __vitePreload(() => import("./ProxyPage-Bye7aYXm.js"), true ? __vite__mapDeps([7,1,2,3,8,5,4,9,10,6]) : void 0, import.meta.url));
const ModernChatPage = reactExports.lazy(() => __vitePreload(() => import("./ModernChatPage-CWzCaKz9.js"), true ? __vite__mapDeps([11,1,2,3,4,5,6]) : void 0, import.meta.url));
const DevEnvironmentPage = reactExports.lazy(() => __vitePreload(() => import("./DevEnvironmentPage-BUu1fveJ.js"), true ? __vite__mapDeps([12,1,2,3,8,5,4,9,6]) : void 0, import.meta.url));
const SettingsPage = reactExports.lazy(() => __vitePreload(() => import("./SettingsPage-C1dAb78w.js"), true ? __vite__mapDeps([13,1,2,3,5,4,9,6]) : void 0, import.meta.url));
const LLMConfigPage = reactExports.lazy(() => __vitePreload(() => import("./LLMConfigPage-Bqdyo4zP.js"), true ? __vite__mapDeps([14,1,2,3,8,5,4,9,6]) : void 0, import.meta.url));
const InfoPage = reactExports.lazy(() => __vitePreload(() => import("./InfoPage-CcArLvtD.js"), true ? __vite__mapDeps([15,1,2,3,8,5,4,9,6]) : void 0, import.meta.url));
const preloadPage = (importFn) => {
  setTimeout(importFn, 100);
};
const preloadCommonPages = () => {
  preloadPage(() => __vitePreload(() => import("./ProxyPage-Bye7aYXm.js"), true ? __vite__mapDeps([7,1,2,3,8,5,4,9,10,6]) : void 0, import.meta.url));
  preloadPage(() => __vitePreload(() => import("./SettingsPage-C1dAb78w.js"), true ? __vite__mapDeps([13,1,2,3,5,4,9,6]) : void 0, import.meta.url));
  preloadPage(() => __vitePreload(() => import("./DevEnvironmentPage-BUu1fveJ.js"), true ? __vite__mapDeps([12,1,2,3,8,5,4,9,6]) : void 0, import.meta.url));
};
const PageLoader = () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
  ...
  alignItems: "center",
  height: "100vh"
}, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Loading..." }) });
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ConfigProvider, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(MainLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/llm-config", element: /* @__PURE__ */ jsxRuntimeExports.jsx(LLMConfigPage, {}) }),
...
ReactDOM.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CustomThemeProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(UserProvider, { children: [
